        ...
        SwipeToDismissBox(
            ...
            backgroundContent = {
                Row(
                    ...
                    Column(
                        modifier = Modifier.padding(12.dp).fillMaxHeight().background(MaterialTheme.colorScheme.error).padding(12.dp),
                        verticalArrangement = Arrangement.Center,
                    ) {
                        Icon(painter = painterResource(R.drawable.outline_delete_24), contentDescription = "Delete", tint = MaterialTheme.colorScheme.onError)
                    }
                }
            }
        ) {
